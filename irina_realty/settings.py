...
WSGI_APPLICATION = 'irina_realty.wsgi.application'

# База данных: PostgreSQL через переменную DATABASE_URL (на Render)
# Локально можно использовать SQLite, если DATABASE_URL не задана
...
# Media files (загружаемые пользователями фото)
MEDIA_URL = '/media/'
